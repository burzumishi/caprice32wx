...
EmulatorWindow::EmulatorWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxFrame( parent, id, title, pos, size, style, name )
{
	...
	m_menu_insertDiscA = new wxMenuItem( m_menu_drivea, 9999, wxString( "Insert Disc Image" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_drivea->Append( m_menu_insertDiscA );
	
	wxMenuItem* m_menu_insertBlakDiskA;
	m_menu_insertBlakDiskA = new wxMenuItem( m_menu_drivea, 9998, wxString( "New Blank Image" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_drivea->Append( m_menu_insertBlakDiskA );
	
	wxMenuItem* m_menu_formatDiscA;
	m_menu_formatDiscA = new wxMenuItem( m_menu_drivea, 9997, wxString( "Format Disc Image" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_drivea->Append( m_menu_formatDiscA );
	m_menu_formatDiscA->Enable( false );
	
	wxMenuItem* menu_editDiskA;
	menu_editDiskA = new wxMenuItem( m_menu_drivea, wxID_ANY, wxString( "Edit Disc" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_drivea->Append( menu_editDiskA );
	
	wxMenuItem* m_menuItem7;
	m_menuItem7 = new wxMenuItem( m_menu_drivea, 9995, wxString( "Remove Disc" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_drivea->Append( m_menuItem7 );
	m_menuItem7->Enable( false );
	
	m_menu_file->Append( -1, "Drive A:", m_menu_drivea );
	
	m_menu_driveb = new wxMenu();
	wxMenuItem* m_menuItem11;
	m_menuItem11 = new wxMenuItem( m_menu_driveb, 9994, wxString( "Insert Disc Image" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_driveb->Append( m_menuItem11 );
	
	wxMenuItem* m_menuItem31;
	m_menuItem31 = new wxMenuItem( m_menu_driveb, 9993, wxString( "New Blank Image" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_driveb->Append( m_menuItem31 );
	
	wxMenuItem* m_menuItem41;
	m_menuItem41 = new wxMenuItem( m_menu_driveb, 9992, wxString( "Format Disc Image" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_driveb->Append( m_menuItem41 );
	m_menuItem41->Enable( false );
	
	wxMenuItem* menu_editDiskB;
	menu_editDiskB = new wxMenuItem( m_menu_driveb, wxID_ANY, wxString( "Edit Disc" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_driveb->Append( menu_editDiskB );
	
	wxMenuItem* m_menuItem61;
	m_menuItem61 = new wxMenuItem( m_menu_driveb, 9990, wxString( "Flip Disc" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_driveb->Append( m_menuItem61 );
	
	wxMenuItem* m_menuItem71;
	m_menuItem71 = new wxMenuItem( m_menu_driveb, 9989, wxString( "Remove Disc" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_driveb->Append( m_menuItem71 );
	m_menuItem71->Enable( false );
	
	m_menu_file->Append( -1, "Drive B:", m_menu_driveb );
	
	wxMenuItem* m_menuItem8;
	m_menuItem8 = new wxMenuItem( m_menu_file, 9988, wxString( "Swap Disc A and  B" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_menuItem8 );
	
	wxMenuItem* m_menuItem24;
	m_menuItem24 = new wxMenuItem( m_menu_file, 9987, wxString( "Load Cartridge" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_menuItem24 );
	
	m_Tape = new wxMenu();
	wxMenuItem* m_menuItem25;
	m_menuItem25 = new wxMenuItem( m_Tape, 9986, wxString( "Show Tape Controls" ) , wxEmptyString, wxITEM_NORMAL );
	m_Tape->Append( m_menuItem25 );
	
	wxMenuItem* m_menuItem26;
	m_menuItem26 = new wxMenuItem( m_Tape, 9985, wxString( "Insert Tape Image" ) , wxEmptyString, wxITEM_NORMAL );
	m_Tape->Append( m_menuItem26 );
	
	wxMenuItem* m_menuItem27;
	m_menuItem27 = new wxMenuItem( m_Tape, 9984, wxString( "Rewind Tape" ) , wxEmptyString, wxITEM_NORMAL );
	m_Tape->Append( m_menuItem27 );
	m_menuItem27->Enable( false );
	
	wxMenuItem* m_menuItem28;
	m_menuItem28 = new wxMenuItem( m_Tape, 9983, wxString( "Remove Tape" ) , wxEmptyString, wxITEM_NORMAL );
	m_Tape->Append( m_menuItem28 );
	m_menuItem28->Enable( false );
	
	wxMenuItem* m_menuItem29;
	m_menuItem29 = new wxMenuItem( m_Tape, 9982, wxString( "Press Play" ) , wxEmptyString, wxITEM_NORMAL );
	m_Tape->Append( m_menuItem29 );
	
	wxMenuItem* m_menuItem30;
	m_menuItem30 = new wxMenuItem( m_Tape, 9981, wxString( "Press Record" ) , wxEmptyString, wxITEM_NORMAL );
	m_Tape->Append( m_menuItem30 );
	
	wxMenuItem* m_menuItem6;
	m_menuItem6 = new wxMenuItem( m_Tape, 9980, wxString( "Flip Tape" ) , wxEmptyString, wxITEM_NORMAL );
	m_Tape->Append( m_menuItem6 );
	
	m_menu_file->Append( -1, "Tape", m_Tape );
	
	wxMenuItem* m_separator1;
	m_separator1 = m_menu_file->AppendSeparator();
	
	wxMenuItem* m_mI_LoadSNA;
	m_mI_LoadSNA = new wxMenuItem( m_menu_file, 9979, wxString( "Load Snapshot" ) + '\t' + "F3", wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_mI_LoadSNA );
	
	wxMenuItem* m_ml_ReloadSNA;
	m_ml_ReloadSNA = new wxMenuItem( m_menu_file, wxID_ANY, wxString( "Reload Snapshot" ) + '\t' + "CTRL+F3", wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_ml_ReloadSNA );
	
	wxMenuItem* m_mI_SaveSNA;
	m_mI_SaveSNA = new wxMenuItem( m_menu_file, 9978, wxString( "Save Snapshot" ) + '\t' + "F2", wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_mI_SaveSNA );
	
	wxMenuItem* m_ml_UpdateSNA;
	m_ml_UpdateSNA = new wxMenuItem( m_menu_file, wxID_ANY, wxString( "Update Snapshot" ) + '\t' + "CTRL+F2", wxEmptyString, wxITEM_NORMAL );
	...
	m_menuItem34 = new wxMenuItem( m_menu_file, 9976, wxString( "Playback Session" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_menuItem34 );
	
	wxMenuItem* m_menuItem35;
	m_menuItem35 = new wxMenuItem( m_menu_file, 9975, wxString( "Record Session" ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_mI_SaveSCR = new wxMenuItem( m_menu_file, 9974, wxString( "Save Screenshot" ) + '\t' + "F12", wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_mI_SaveSCR );
	
	wxMenuItem* m_menu_insertDiscA1;
	m_menu_insertDiscA1 = new wxMenuItem( m_menu_file, 9973, wxString( "Insert Disc Image" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_menu_insertDiscA1 );
	
	wxMenuItem* m_menuItem37;
	m_menuItem37 = new wxMenuItem( m_menu_file, 9972, wxString( "Record AVI" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_menuItem37 );
	
	wxMenuItem* m_menuItem38;
	m_menuItem38 = new wxMenuItem( m_menu_file, 9971, wxString( "Record WAV" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_menuItem38 );
	
	wxMenuItem* m_menuItem39;
	m_menuItem39 = new wxMenuItem( m_menu_file, 9970, wxString( "Record YM" ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_menuItem40 = new wxMenuItem( m_menu_file, 9969, wxString( "Pokes" ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_menuItem411 = new wxMenuItem( m_menu_file, 9968, wxString( "Auto Types" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_menuItem411 );
	
	wxMenuItem* m_menuItem42;
	m_menuItem42 = new wxMenuItem( m_menu_file, 9967, wxString( "Paste" ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_menu_exit = new wxMenuItem( m_menu_file, 9966, wxString( "Exit" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_file->Append( m_menu_exit );
	
	m_menubar1->Append( m_menu_file, "File" ); 
	
	m_menu_settings = new wxMenu();
	wxMenuItem* m_menu_input;
	m_menu_input = new wxMenuItem( m_menu_settings, 9965, wxString( "Input" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_settings->Append( m_menu_input );
	
	wxMenuItem* m_menu_memory;
	m_menu_memory = new wxMenuItem( m_menu_settings, 9964, wxString( "Memory" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_settings->Append( m_menu_memory );
	
	wxMenuItem* m_menu_video;
	m_menu_video = new wxMenuItem( m_menu_settings, 9963, wxString( "Video" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_settings->Append( m_menu_video );
	
	wxMenuItem* m_menu_sound;
	m_menu_sound = new wxMenuItem( m_menu_settings, 9962, wxString( "Sound" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_settings->Append( m_menu_sound );
	
	wxMenuItem* m_menu_miscsettings;
	m_menu_miscsettings = new wxMenuItem( m_menu_settings, 9961, wxString( "Other" ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_menuItem49 = new wxMenuItem( m_menu_settings, 9960, wxString( "Full Screen" ) + '\t' + "F1", wxEmptyString, wxITEM_NORMAL );
	m_menu_settings->Append( m_menuItem49 );
	
	wxMenuItem* m_menuItem50;
	m_menuItem50 = new wxMenuItem( m_menu_settings, 9959, wxString( "Reset" ) + '\t' + "F5", wxEmptyString, wxITEM_NORMAL );
	m_menu_settings->Append( m_menuItem50 );
	
	wxMenuItem* m_menuItem511;
	m_menuItem511 = new wxMenuItem( m_menu_settings, 9958, wxString( "AMX Mouse" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_settings->Append( m_menuItem511 );
	
	wxMenuItem* m_menuItem52;
	m_menuItem52 = new wxMenuItem( m_menu_settings, 9957, wxString( "Multiface Stop" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_settings->Append( m_menuItem52 );
	
	m_menubar1->Append( m_menu_settings, "Settings" ); 
	
	m_menu_debug = new wxMenu();
	m_menuItem_run = new wxMenuItem( m_menu_debug, 9956, wxString( "Run" ) + '\t' + "F6", wxEmptyString, wxITEM_NORMAL );
	m_menu_debug->Append( m_menuItem_run );
	m_menuItem_run->Enable( false );
	
	wxMenuItem* m_menuItem_step;
	m_menuItem_step = new wxMenuItem( m_menu_debug, 9955, wxString( "Step" ) + '\t' + "F7", wxEmptyString, wxITEM_NORMAL );
	m_menu_debug->Append( m_menuItem_step );
	
	m_menuItem_pause = new wxMenuItem( m_menu_debug, 9954, wxString( "Pause" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_debug->Append( m_menuItem_pause );
	
	wxMenuItem* m_menuItem_registers;
	m_menuItem_registers = new wxMenuItem( m_menu_debug, 9953, wxString( "Register" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_debug->Append( m_menuItem_registers );
	
	wxMenuItem* m_menuItem_memory;
	m_menuItem_memory = new wxMenuItem( m_menu_debug, 9952, wxString( "Memory" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu_debug->Append( m_menuItem_memory );
	
	m_menubar1->Append( m_menu_debug, "Debug" ); 
	
	m_menu4 = new wxMenu();
	wxMenuItem* m_menuItem57;
	m_menuItem57 = new wxMenuItem( m_menu4, 9951, wxString( "Show Assembler" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( m_menuItem57 );
	
	m_menubar1->Append( m_menu4, "Assembler" ); 
	
	m_menu5 = new wxMenu();
	wxMenuItem* m_menuItem491;
	m_menuItem491 = new wxMenuItem( m_menu5, 9950, wxString( "About" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu5->Append( m_menuItem491 );
	
	m_menubar1->Append( m_menu5, "Help" ); 
	...
	m_statusText = new wxStaticText( this, wxID_ANY, "Welcome to Caprice32Reloaded!", wxDefaultPosition, wxDefaultSize, wxST_NO_AUTORESIZE|wxSUNKEN_BORDER );
	m_statusText->Wrap( -1 );
...
Settings::Settings( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText63 = new wxStaticText( m_panel_input, wxID_ANY, "Preset", wxDefaultPosition, wxDefaultSize, 0 );
	...
	k_TAB = new wxButton( m_panel_input, CPC_TAB, "TAB", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB, wxGBPosition( 1, 0 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );
	
	k_TAB1 = new wxButton( m_panel_input, CPC_Q, "A", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB1, wxGBPosition( 1, 2 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB2 = new wxButton( m_panel_input, CPC_W, "Z", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB2, wxGBPosition( 1, 3 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB3 = new wxButton( m_panel_input, CPC_E, "E", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB3, wxGBPosition( 1, 4 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB4 = new wxButton( m_panel_input, CPC_R, "R", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB4, wxGBPosition( 1, 5 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB5 = new wxButton( m_panel_input, CPC_T, "T", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB5, wxGBPosition( 1, 6 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB6 = new wxButton( m_panel_input, CPC_Y, "Y", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB6, wxGBPosition( 1, 7 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB7 = new wxButton( m_panel_input, CPC_U, "U", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB7, wxGBPosition( 1, 8 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB8 = new wxButton( m_panel_input, CPC_I, "I", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB8, wxGBPosition( 1, 9 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB9 = new wxButton( m_panel_input, CPC_O, "O", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB9, wxGBPosition( 1, 10 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB10 = new wxButton( m_panel_input, CPC_P, "P", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB10, wxGBPosition( 1, 11 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB11 = new wxButton( m_panel_input, CPC_AT, "|^", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB11, wxGBPosition( 1, 12 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB12 = new wxButton( m_panel_input, CPC_LBRACKET, "<*", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB12, wxGBPosition( 1, 13 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB13 = new wxButton( m_panel_input, CPC_RETURN, "RET", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT|wxWANTS_CHARS );
	gbSizer1->Add( k_TAB13, wxGBPosition( 1, 14 ), wxGBSpan( 2, 1 ), wxEXPAND, 5 );
	
	k_TAB14 = new wxButton( m_panel_input, CPC_F4, "F4", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB14, wxGBPosition( 1, 15 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB15 = new wxButton( m_panel_input, CPC_F5, "F5", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB15, wxGBPosition( 1, 16 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_TAB16 = new wxButton( m_panel_input, CPC_F6, "F6", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_TAB16, wxGBPosition( 1, 17 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS = new wxButton( m_panel_input, CPC_CAPSLOCK, "CAPS", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS, wxGBPosition( 2, 0 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );
	
	k_CAPS1 = new wxButton( m_panel_input, CPC_A, "Q", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS1, wxGBPosition( 2, 2 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS2 = new wxButton( m_panel_input, CPC_S, "S", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS2, wxGBPosition( 2, 3 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS3 = new wxButton( m_panel_input, CPC_D, "D", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS3, wxGBPosition( 2, 4 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS4 = new wxButton( m_panel_input, CPC_F, "F", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS4, wxGBPosition( 2, 5 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS5 = new wxButton( m_panel_input, CPC_G, "G", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS5, wxGBPosition( 2, 6 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS6 = new wxButton( m_panel_input, CPC_H, "H", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS6, wxGBPosition( 2, 7 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS7 = new wxButton( m_panel_input, CPC_J, "J", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS7, wxGBPosition( 2, 8 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS8 = new wxButton( m_panel_input, CPC_K, "K", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS8, wxGBPosition( 2, 9 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS9 = new wxButton( m_panel_input, CPC_L, "L", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS9, wxGBPosition( 2, 10 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS10 = new wxButton( m_panel_input, CPC_COLON, "M", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS10, wxGBPosition( 2, 11 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS11 = new wxButton( m_panel_input, CPC_SEMICOLON, "%", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS11, wxGBPosition( 2, 12 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS12 = new wxButton( m_panel_input, CPC_RBRACKET, ">#", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS12, wxGBPosition( 2, 13 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS13 = new wxButton( m_panel_input, CPC_F1, "F1", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS13, wxGBPosition( 2, 15 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS14 = new wxButton( m_panel_input, CPC_F2, "F2", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS14, wxGBPosition( 2, 16 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CAPS15 = new wxButton( m_panel_input, CPC_F3, "F3", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CAPS15, wxGBPosition( 2, 17 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT = new wxButton( m_panel_input, CPC_LSHIFT, "SHIFT", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT, wxGBPosition( 3, 0 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );
	
	k_LSHIFT1 = new wxButton( m_panel_input, CPC_Z, "W", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT1, wxGBPosition( 3, 2 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT2 = new wxButton( m_panel_input, CPC_X, "X", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT2, wxGBPosition( 3, 3 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT3 = new wxButton( m_panel_input, CPC_C, "C", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT3, wxGBPosition( 3, 4 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT4 = new wxButton( m_panel_input, CPC_V, "V", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT4, wxGBPosition( 3, 5 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT5 = new wxButton( m_panel_input, CPC_B, "B", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT5, wxGBPosition( 3, 6 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT6 = new wxButton( m_panel_input, CPC_N, "N", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT6, wxGBPosition( 3, 7 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT7 = new wxButton( m_panel_input, CPC_M, "?,", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT7, wxGBPosition( 3, 8 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT8 = new wxButton( m_panel_input, CPC_COMMA, ".;", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT8, wxGBPosition( 3, 9 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT9 = new wxButton( m_panel_input, CPC_PERIOD, "/:", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT9, wxGBPosition( 3, 10 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT10 = new wxButton( m_panel_input, CPC_SLASH, "+=", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT10, wxGBPosition( 3, 11 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT11 = new wxButton( m_panel_input, CPC_BACKSLASH, "@\\$", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT11, wxGBPosition( 3, 12 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT12 = new wxButton( m_panel_input, CPC_RSHIFT, "SHIFT", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT12, wxGBPosition( 3, 13 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );
	
	k_LSHIFT13 = new wxButton( m_panel_input, CPC_F0, "F0", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT13, wxGBPosition( 3, 15 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT14 = new wxButton( m_panel_input, CPC_CUR_UP, "^^", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT14, wxGBPosition( 3, 16 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_LSHIFT15 = new wxButton( m_panel_input, CPC_FPERIOD, ".", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_LSHIFT15, wxGBPosition( 3, 17 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CONTROL = new wxButton( m_panel_input, CPC_CONTROL, "CONTROL", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CONTROL, wxGBPosition( 4, 0 ), wxGBSpan( 1, 2 ), wxEXPAND, 5 );
	
	k_CONTROL1 = new wxButton( m_panel_input, CPC_COPY, "COPY", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	k_CONTROL3 = new wxButton( m_panel_input, CPC_ENTER, "ENTER", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CONTROL3, wxGBPosition( 4, 12 ), wxGBSpan( 1, 3 ), wxEXPAND, 5 );
	
	k_CONTROL4 = new wxButton( m_panel_input, CPC_CUR_LEFT, "<<", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CONTROL4, wxGBPosition( 4, 15 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CONTROL5 = new wxButton( m_panel_input, CPC_CUR_DOWN, "vv", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT|wxWANTS_CHARS );
	gbSizer1->Add( k_CONTROL5, wxGBPosition( 4, 16 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_CONTROL6 = new wxButton( m_panel_input, CPC_CUR_RIGHT, ">>", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_CONTROL6, wxGBPosition( 4, 17 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC = new wxButton( m_panel_input, CPC_ESC, "ESC", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC1 = new wxButton( m_panel_input, CPC_1, "1&&", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC1, wxGBPosition( 0, 1 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC2 = new wxButton( m_panel_input, CPC_2, "2", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC2, wxGBPosition( 0, 2 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC3 = new wxButton( m_panel_input, CPC_3, "3\"", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC3, wxGBPosition( 0, 3 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC4 = new wxButton( m_panel_input, CPC_4, "4'", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC4, wxGBPosition( 0, 4 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC5 = new wxButton( m_panel_input, CPC_5, "5(", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC5, wxGBPosition( 0, 5 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC6 = new wxButton( m_panel_input, CPC_6, "6]", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC6, wxGBPosition( 0, 6 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC7 = new wxButton( m_panel_input, CPC_7, "7", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC7, wxGBPosition( 0, 7 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC8 = new wxButton( m_panel_input, CPC_8, "8!", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC8, wxGBPosition( 0, 8 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC9 = new wxButton( m_panel_input, CPC_9, "9", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC9, wxGBPosition( 0, 9 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC10 = new wxButton( m_panel_input, CPC_0, "0", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC10, wxGBPosition( 0, 10 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC11 = new wxButton( m_panel_input, CPC_MINUS, "[)", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC11, wxGBPosition( 0, 11 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC12 = new wxButton( m_panel_input, CPC_POWER, "_-", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC12, wxGBPosition( 0, 12 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC13 = new wxButton( m_panel_input, CPC_CLR, "CLR", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC13, wxGBPosition( 0, 13 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC14 = new wxButton( m_panel_input, CPC_DEL, "DEL", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC14, wxGBPosition( 0, 14 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC15 = new wxButton( m_panel_input, CPC_F7, "F7", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC15, wxGBPosition( 0, 15 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC16 = new wxButton( m_panel_input, CPC_F8, "F8", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	gbSizer1->Add( k_ESC16, wxGBPosition( 0, 16 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	k_ESC17 = new wxButton( m_panel_input, CPC_F9, "F9", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
	...
	m_staticText65 = new wxStaticText( m_panel_input, wxID_ANY, "Settings for key :", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText67 = new wxStaticText( m_panel_input, wxID_ANY, "PC key to use :", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText68 = new wxStaticText( m_panel_input, wxID_ANY, "PC key to use for shift+key :", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText69 = new wxStaticText( m_panel_input, wxID_ANY, "PC key to use for control+key :", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_notebook4->AddPage( m_panel_input, "Input", true );
	...
	m_staticText62 = new wxStaticText( m_panel_memory, wxID_ANY, "RAM", wxDefaultPosition, wxDefaultSize, 0 );
	...
	RAMSize64 = new wxRadioButton( m_panel_memory, wxID_ANY, "64k", wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	bSizer23->Add( RAMSize64, 0, wxALL|wxFIXED_MINSIZE, 5 );
	
	RAMSize128 = new wxRadioButton( m_panel_memory, wxID_ANY, "128k", wxDefaultPosition, wxDefaultSize, 0 );
	RAMSize128->SetValue( true ); 
	bSizer23->Add( RAMSize128, 0, wxALL|wxFIXED_MINSIZE, 5 );
	
	RAMSize576 = new wxRadioButton( m_panel_memory, wxID_ANY, "576k", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText71 = new wxStaticText( m_panel_memory, wxID_ANY, "ROMs", wxDefaultPosition, wxDefaultSize, 0 );
	...
	LKs = new wxStaticText( m_panel_memory, wxID_ANY, "LKs", wxDefaultPosition, wxDefaultSize, 0 );
	LKs->Wrap( -1 );
	LKs->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 92, false, wxEmptyString ) );
	
	bSizer45->Add( LKs, 0, wxALL, 5 );
	
	wxString manufacturerNameChoices[] = { "Amstrad", "Orion", "Schneider", "Awa", "Solavox", "Saisho", "Triumph", "ISP" };
	...
	radio50 = new wxRadioButton( m_panel_memory, wxID_ANY, "50Hz", wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	radio50->SetValue( true ); 
	bSizer45->Add( radio50, 0, wxALL, 5 );
	
	radio60 = new wxRadioButton( m_panel_memory, wxID_ANY, "60Hz", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_notebook4->AddPage( m_panel_memory, "Memory", false );
	m_panel_video = new wxPanel( m_notebook4, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	wxBoxSizer* bSizer32;
	bSizer32 = new wxBoxSizer( wxVERTICAL );
	
	check_OpenGL = new wxCheckBox( m_panel_video, wxID_ANY, "OpenGL", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer32->Add( check_OpenGL, 0, wxALL, 5 );
	
	wxBoxSizer* bSizer36;
	bSizer36 = new wxBoxSizer( wxHORIZONTAL );
	
	m_staticText76 = new wxStaticText( m_panel_video, wxID_ANY, "CRTC: ", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText761 = new wxStaticText( m_panel_video, wxID_ANY, "Palette:", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText761->Wrap( -1 );
	bSizer361->Add( m_staticText761, 0, wxALL, 5 );
	
	wxString choice_colorPaletteChoices[] = { "GT65", "Grey", "Plus color", "CTM644", "Custom" };
	...
	m_button76 = new wxButton( m_panel_video, wxID_ANY, "Edit custom palette", wxDefaultPosition, wxDefaultSize, 0 );
	m_button76->Hide();
	...
	m_notebook4->AddPage( m_panel_video, "Video", false );
	...
	m_radioBtn11 = new wxRadioButton( m_panel_sound, wxID_ANY, "8 bit", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer42->Add( m_radioBtn11, 0, wxALL, 5 );
	
	m_radioBtn12 = new wxRadioButton( m_panel_sound, wxID_ANY, "16 bit", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText75 = new wxStaticText( m_panel_sound, wxID_ANY, "Bitrate", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_radioBtn111 = new wxRadioButton( m_panel_sound, wxID_ANY, "Mono", wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	bSizer421->Add( m_radioBtn111, 0, wxALL, 5 );
	
	m_radioBtn121 = new wxRadioButton( m_panel_sound, wxID_ANY, "Stereo", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_notebook4->AddPage( m_panel_sound, "Sound", false );
	...
	m_button80 = new wxButton( this, wxID_ANY, "Cancel", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer46->Add( m_button80, 0, wxALL, 5 );
	
	m_button81 = new wxButton( this, wxID_ANY, "Apply", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer46->Add( m_button81, 0, wxALL, 5 );
	
	m_button79 = new wxButton( this, wxID_ANY, "Save as default", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer46->Add( m_button79, 0, wxALL, 5 );
	
	m_comboBox2 = new wxComboBox( this, wxID_ANY, "CPC 6128", wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
	m_comboBox2->Append( "CPC 464" );
	m_comboBox2->Append( "CPC 664" );
	m_comboBox2->Append( "CPC 6128" );
	m_comboBox2->Append( "464 Plus" );
	m_comboBox2->Append( "6128 Plus" );
	bSizer46->Add( m_comboBox2, 0, wxALL, 5 );
	
	m_button78 = new wxButton( this, wxID_ANY, "Save as profile", wxDefaultPosition, wxDefaultSize, 0 );
...
FileProperties::FileProperties( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText26 = new wxStaticText( this, wxID_ANY, "Type Of File", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText26->Wrap( -1 );
	bSizer8->Add( m_staticText26, 0, wxALL, 5 );
	
	m_staticText27 = new wxStaticText( this, wxID_ANY, "MyLabel", wxDefaultPosition, wxDefaultSize, 0 );
...
About::About( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_bitmap2 = new wxStaticBitmap( this, wxID_ANY, wxBitmap( "logo.png", wxBITMAP_TYPE_ANY ), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer9->Add( m_bitmap2, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	m_staticText8 = new wxStaticText( this, wxID_ANY, "Caprice32Reloaded", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
	m_staticText8->Wrap( -1 );
	m_staticText8->SetFont( wxFont( 18, 74, 90, 90, false, "Sans" ) );
	
	bSizer9->Add( m_staticText8, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	m_staticText9 = new wxStaticText( this, wxID_ANY, "An OpenSource Amstrad CPC Emulator", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
	m_staticText9->Wrap( -1 );
	m_staticText9->SetFont( wxFont( 12, 74, 90, 92, false, "Sans" ) );
	
	bSizer9->Add( m_staticText9, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxEXPAND, 5 );
	
	m_staticText5 = new wxStaticText( this, wxID_ANY, "Based on sourcecode from Caprice 32 :\n(c) 1997 - 2005 Ulrich Doewich\n\nReloaded is :\n(c) 1997 - 2010 The Reloaded Author's\n(c)2014 Caprice32Reloaded by Antonio Cao", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE );
...
RegistersStates::RegistersStates( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	sbSizer1 = new wxStaticBoxSizer( new wxStaticBox( z80_tab, wxID_ANY, "8bits Registers" ), wxVERTICAL );
	...
	m_staticText9 = new wxStaticText( z80_tab, wxID_ANY, "MyLabel", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText9->Wrap( -1 );
	m_staticText9->Hide();
	
	fgSizer3->Add( m_staticText9, 0, wxALL, 5 );
	
	m_staticText10 = new wxStaticText( z80_tab, wxID_ANY, "Primary", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText10->Wrap( -1 );
	fgSizer3->Add( m_staticText10, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticText11 = new wxStaticText( z80_tab, wxID_ANY, "Shadow", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText11->Wrap( -1 );
	fgSizer3->Add( m_staticText11, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticText12 = new wxStaticText( z80_tab, wxID_ANY, "A", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText13 = new wxStaticText( z80_tab, wxID_ANY, "F", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText14 = new wxStaticText( z80_tab, wxID_ANY, "B", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText15 = new wxStaticText( z80_tab, wxID_ANY, "C", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText16 = new wxStaticText( z80_tab, wxID_ANY, "D", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText17 = new wxStaticText( z80_tab, wxID_ANY, "E", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText18 = new wxStaticText( z80_tab, wxID_ANY, "H", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText19 = new wxStaticText( z80_tab, wxID_ANY, "L", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText31 = new wxStaticText( z80_tab, wxID_ANY, "I", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText33 = new wxStaticText( z80_tab, wxID_ANY, "R", wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer2 = new wxStaticBoxSizer( new wxStaticBox( z80_tab, wxID_ANY, "16bits Registers" ), wxVERTICAL );
	...
	m_staticText22 = new wxStaticText( z80_tab, wxID_ANY, "Primary", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText22->Wrap( -1 );
	fgSizer5->Add( m_staticText22, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticText23 = new wxStaticText( z80_tab, wxID_ANY, "Shadow", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText23->Wrap( -1 );
	fgSizer5->Add( m_staticText23, 0, wxALIGN_CENTER_HORIZONTAL|wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticText24 = new wxStaticText( z80_tab, wxID_ANY, "BC", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText25 = new wxStaticText( z80_tab, wxID_ANY, "DE", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText26 = new wxStaticText( z80_tab, wxID_ANY, "HL", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText26->Wrap( -1 );
	...
	m_staticText27 = new wxStaticText( z80_tab, wxID_ANY, "IX", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText27->Wrap( -1 );
	...
	m_staticText28 = new wxStaticText( z80_tab, wxID_ANY, "IY", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText29 = new wxStaticText( z80_tab, wxID_ANY, "PC", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText30 = new wxStaticText( z80_tab, wxID_ANY, "SP", wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer3 = new wxStaticBoxSizer( new wxStaticBox( z80_tab, wxID_ANY, "Flags States" ), wxVERTICAL );
	...
	m_staticText35 = new wxStaticText( z80_tab, wxID_ANY, "S", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText35->Wrap( -1 );
	fgSizer6->Add( m_staticText35, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText36 = new wxStaticText( z80_tab, wxID_ANY, "Z", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText36->Wrap( -1 );
	fgSizer6->Add( m_staticText36, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText37 = new wxStaticText( z80_tab, wxID_ANY, "H", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText37->Wrap( -1 );
	fgSizer6->Add( m_staticText37, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText38 = new wxStaticText( z80_tab, wxID_ANY, "P", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText38->Wrap( -1 );
	fgSizer6->Add( m_staticText38, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText39 = new wxStaticText( z80_tab, wxID_ANY, "N", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText39->Wrap( -1 );
	fgSizer6->Add( m_staticText39, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText40 = new wxStaticText( z80_tab, wxID_ANY, "C", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText40->Wrap( -1 );
	fgSizer6->Add( m_staticText40, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText41 = new wxStaticText( z80_tab, wxID_ANY, "Primary", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText42 = new wxStaticText( z80_tab, wxID_ANY, "Shadow", wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer9 = new wxStaticBoxSizer( new wxStaticBox( z80_tab, wxID_ANY, "Interrupts" ), wxVERTICAL );
	
	m_cb_interruptenabled = new wxCheckBox( z80_tab, wxID_ANY, "enabled", wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer9->Add( m_cb_interruptenabled, 0, wxALL, 5 );
	
	wxString m_c_interruptModeChoices[] = { "IM0", "IM1", "IM2" };
	...
	m_cb_interruptpending = new wxCheckBox( z80_tab, wxID_ANY, "pending", wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer9->Add( m_cb_interruptpending, 0, wxALL, 5 );
	
	m_cb_nmipending = new wxCheckBox( z80_tab, wxID_ANY, "NMI pending", wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer7 = new wxStaticBoxSizer( new wxStaticBox( z80_tab, wxID_ANY, "Shadow Register States" ), wxHORIZONTAL );
	
	m_checkBox15 = new wxCheckBox( z80_tab, wxID_ANY, "AF Register in Shadow", wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer7->Add( m_checkBox15, 0, wxALL|wxFIXED_MINSIZE, 5 );
	
	m_checkBox16 = new wxCheckBox( z80_tab, wxID_ANY, "General Register in Shadow Mode", wxDefaultPosition, wxDefaultSize, 0 );
	...
	tabView->AddPage( z80_tab, "z80", false, wxNullBitmap );
	...
	sbSizer4 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, "Internal" ), wxVERTICAL );
	...
	m_staticText46 = new wxStaticText( crtc_tab, wxID_ANY, "HCC", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcHCC->SetToolTip( "Horizontal Caracter Counter" );
	
	fgSizer9->Add( m_tCcHCC, 0, wxALIGN_CENTER|wxALL, 5 );
	
	m_staticText47 = new wxStaticText( crtc_tab, wxID_ANY, "VCC", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcVCC->SetToolTip( "Vertical Caracter Counter" );
	
	fgSizer9->Add( m_tCcVCC, 0, wxALIGN_CENTER|wxALL, 5 );
	
	m_staticText48 = new wxStaticText( crtc_tab, wxID_ANY, "VLA", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcVLA->SetToolTip( "Vertical Line Adjust" );
	
	fgSizer9->Add( m_tCcVLA, 0, wxALIGN_CENTER|wxALL, 5 );
	
	m_staticText49 = new wxStaticText( crtc_tab, wxID_ANY, "VLC", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcVLC->SetToolTip( "Vertical Line Counter" );
	...
	sbSizer5 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, "Horizontal" ), wxVERTICAL );
	...
	m_staticText50 = new wxStaticText( crtc_tab, wxID_ANY, "R0", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR0->SetToolTip( "Horizontal total character number" );
	
	fgSizer11->Add( m_tCcR0, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText51 = new wxStaticText( crtc_tab, wxID_ANY, "R1", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR1->SetToolTip( "Horizontal displayed character number" );
	
	fgSizer11->Add( m_tCcR1, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText52 = new wxStaticText( crtc_tab, wxID_ANY, "R2", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR2->SetToolTip( "Position of horizontal sync. pulse" );
	
	fgSizer11->Add( m_tCcR2, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_staticText53 = new wxStaticText( crtc_tab, wxID_ANY, "R3", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR3->SetToolTip( "Width of horizontal/vertical sync. pulses" );
	...
	sbSizer6 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, "Vertical" ), wxVERTICAL );
	...
	m_staticText54 = new wxStaticText( crtc_tab, wxID_ANY, "R4", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR4->SetToolTip( " Vertical total Line character number" );
	
	fgSizer12->Add( m_tCcR4, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 0 );
	
	m_staticText55 = new wxStaticText( crtc_tab, wxID_ANY, "R5", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR5->SetToolTip( "Vertical raster adjust" );
	
	fgSizer12->Add( m_tCcR5, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 0 );
	
	m_staticText56 = new wxStaticText( crtc_tab, wxID_ANY, "R6", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR6->SetToolTip( "Vertical displayed character number" );
	
	fgSizer12->Add( m_tCcR6, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 0 );
	
	m_staticText57 = new wxStaticText( crtc_tab, wxID_ANY, "R7", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR7->SetToolTip( "Position of vertical sync. pulse" );
	
	fgSizer12->Add( m_tCcR7, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 0 );
	
	m_staticText58 = new wxStaticText( crtc_tab, wxID_ANY, "R9", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tCcR9->SetToolTip( "Maximum raster" );
	...
	sbSizer12 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, "Other" ), wxVERTICAL );
	...
	m_staticText80 = new wxStaticText( crtc_tab, wxID_ANY, "R8", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText81 = new wxStaticText( crtc_tab, wxID_ANY, "R12", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText82 = new wxStaticText( crtc_tab, wxID_ANY, "R13", wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer8 = new wxStaticBoxSizer( new wxStaticBox( crtc_tab, wxID_ANY, "Timing Check" ), wxVERTICAL );
	...
	m_staticText59 = new wxStaticText( crtc_tab, wxID_ANY, "Horizontal Line Length", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText59->Wrap( -1 );
	fgSizer121->Add( m_staticText59, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_sT_HLineLength = new wxStaticText( crtc_tab, wxID_ANY, "xxxxx us", wxDefaultPosition, wxDefaultSize, 0 );
	m_sT_HLineLength->Wrap( -1 );
	fgSizer121->Add( m_sT_HLineLength, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_cB_HLineLengthIsOk = new wxCheckBox( crtc_tab, wxID_ANY, "Timing is Ok !", wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer121->Add( m_cB_HLineLengthIsOk, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_staticText61 = new wxStaticText( crtc_tab, wxID_ANY, "Vertical Frame Length", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText61->Wrap( -1 );
	fgSizer121->Add( m_staticText61, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_sT_VFrameLength = new wxStaticText( crtc_tab, wxID_ANY, "xxxxx us", wxDefaultPosition, wxDefaultSize, 0 );
	m_sT_VFrameLength->Wrap( -1 );
	fgSizer121->Add( m_sT_VFrameLength, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	
	m_cB_VFrameLengthIsOk = new wxCheckBox( crtc_tab, wxID_ANY, "Timing is Ok !", wxDefaultPosition, wxDefaultSize, 0 );
	...
	tabView->AddPage( crtc_tab, "CRTC", false, wxNullBitmap );
	ga_tab = new wxPanel( tabView, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer43;
	bSizer43 = new wxBoxSizer( wxVERTICAL );
	
	wxStaticBoxSizer* sbSizer14;
	sbSizer14 = new wxStaticBoxSizer( new wxStaticBox( ga_tab, wxID_ANY, "Video" ), wxVERTICAL );
	...
	m_staticText84 = new wxStaticText( ga_tab, wxID_ANY, "Pen", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText85 = new wxStaticText( ga_tab, wxID_ANY, "Video mode", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText86 = new wxStaticText( ga_tab, wxID_ANY, "Pen 0", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText87 = new wxStaticText( ga_tab, wxID_ANY, "Pen 1", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText88 = new wxStaticText( ga_tab, wxID_ANY, "Pen 2", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText89 = new wxStaticText( ga_tab, wxID_ANY, "Pen 3", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText90 = new wxStaticText( ga_tab, wxID_ANY, "Pen 4", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText91 = new wxStaticText( ga_tab, wxID_ANY, "Pen 5", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText92 = new wxStaticText( ga_tab, wxID_ANY, "Pen 6", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText93 = new wxStaticText( ga_tab, wxID_ANY, "Pen 7", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText94 = new wxStaticText( ga_tab, wxID_ANY, "Pen 8", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText95 = new wxStaticText( ga_tab, wxID_ANY, "Pen 9", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText96 = new wxStaticText( ga_tab, wxID_ANY, "Pen 10", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText97 = new wxStaticText( ga_tab, wxID_ANY, "Pen 11", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText98 = new wxStaticText( ga_tab, wxID_ANY, "Pen 12", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText99 = new wxStaticText( ga_tab, wxID_ANY, "Pen 13", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText100 = new wxStaticText( ga_tab, wxID_ANY, "Pen 14", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText101 = new wxStaticText( ga_tab, wxID_ANY, "Pen 15", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText102 = new wxStaticText( ga_tab, wxID_ANY, "Border", wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer16 = new wxStaticBoxSizer( new wxStaticBox( ga_tab, wxID_ANY, "Memory" ), wxHORIZONTAL );
	
	m_staticText103 = new wxStaticText( ga_tab, wxID_ANY, "MyLabel", wxDefaultPosition, wxDefaultSize, 0 );
	...
	ga_tab->Layout();
	bSizer43->Fit( ga_tab );
	tabView->AddPage( ga_tab, "Gate Array", false, wxNullBitmap );
	fdc_tab = new wxPanel( tabView, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL, "FDC" );
	wxBoxSizer* bSizer48;
	...
	sbSizer161 = new wxStaticBoxSizer( new wxStaticBox( fdc_tab, wxID_ANY, "Drive A" ), wxVERTICAL );
	
	wxGridSizer* gSizer4;
	gSizer4 = new wxGridSizer( 2, 2, 0, 0 );
	
	m_staticText115 = new wxStaticText( fdc_tab, wxID_ANY, "Track", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText116 = new wxStaticText( fdc_tab, wxID_ANY, "Sector", wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer17 = new wxStaticBoxSizer( new wxStaticBox( fdc_tab, wxID_ANY, "Drive B" ), wxHORIZONTAL );
	
	wxGridSizer* gSizer5;
	gSizer5 = new wxGridSizer( 2, 2, 0, 0 );
	
	m_staticText117 = new wxStaticText( fdc_tab, wxID_ANY, "Track", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText118 = new wxStaticText( fdc_tab, wxID_ANY, "Sector", wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer15 = new wxStaticBoxSizer( new wxStaticBox( fdc_tab, wxID_ANY, "Registers" ), wxVERTICAL );
	...
	m_staticText125 = new wxStaticText( fdc_tab, wxID_ANY, "ST0", wxDefaultPosition, wxDefaultSize, 0 );
	...
	c_motor = new wxCheckBox( fdc_tab, wxID_ANY, "Motor", wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer131->Add( c_motor, 0, wxALL, 5 );
	
	m_staticText126 = new wxStaticText( fdc_tab, wxID_ANY, "ST1", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText128 = new wxStaticText( fdc_tab, wxID_ANY, "ST3", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText128->Wrap( -1 );
	fgSizer131->Add( m_staticText128, 0, wxALL, 5 );
	
	m_staticText127 = new wxStaticText( fdc_tab, wxID_ANY, "ST2", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText124 = new wxStaticText( fdc_tab, wxID_ANY, "Access log", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText124->Wrap( -1 );
	bSizer52->Add( m_staticText124, 0, wxALL, 5 );
	
	m_button83 = new wxButton( fdc_tab, wxID_ANY, "Clear", wxDefaultPosition, wxDefaultSize, 0 );
	...
	tabView->AddPage( fdc_tab, "FDC", false, wxNullBitmap );
...
Memory::Memory( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText107 = new wxStaticText( m_panel16, wxID_ANY, "&&0000", wxDefaultPosition, wxSize( -1,64 ), wxST_NO_AUTORESIZE );
	...
	m_staticText108 = new wxStaticText( m_panel16, wxID_ANY, "&&4000", wxDefaultPosition, wxSize( -1,64 ), 0 );
	m_staticText108->Wrap( -1 );
	bSizer47->Add( m_staticText108, 0, wxLEFT, 5 );
	
	m_staticText109 = new wxStaticText( m_panel16, wxID_ANY, "&&8000", wxDefaultPosition, wxSize( -1,64 ), 0 );
	m_staticText109->Wrap( -1 );
	bSizer47->Add( m_staticText109, 0, wxLEFT, 5 );
	
	m_staticText110 = new wxStaticText( m_panel16, wxID_ANY, "&&C000", wxDefaultPosition, wxSize( -1,64 ), 0 );
	...
	zone0 = new wxStaticText( m_panel16, wxID_ANY, "Central RAM", wxDefaultPosition, wxSize( -1,64 ), wxST_NO_AUTORESIZE );
	zone0->Wrap( -1 );
	bSizer48->Add( zone0, 0, wxEXPAND|wxLEFT, 5 );
	
	zone1 = new wxStaticText( m_panel16, wxID_ANY, "Central RAM", wxDefaultPosition, wxSize( -1,64 ), wxST_NO_AUTORESIZE );
	zone1->Wrap( -1 );
	bSizer48->Add( zone1, 0, wxEXPAND|wxLEFT, 5 );
	
	zone2 = new wxStaticText( m_panel16, wxID_ANY, "Central RAM", wxDefaultPosition, wxSize( -1,64 ), wxST_NO_AUTORESIZE );
	zone2->Wrap( -1 );
	bSizer48->Add( zone2, 0, wxEXPAND|wxLEFT, 5 );
	
	zone3 = new wxStaticText( m_panel16, wxID_ANY, "Central RAM", wxDefaultPosition, wxSize( -1,32 ), wxST_NO_AUTORESIZE );
	zone3->Wrap( -1 );
	bSizer48->Add( zone3, 0, wxEXPAND|wxLEFT, 5 );
	
	m_staticText106 = new wxStaticText( m_panel16, wxID_ANY, "Double-click somewhere to jump!", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText102 = new wxStaticText( m_panel16, wxID_ANY, "View", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText102->Wrap( -1 );
	fgSizer12->Add( m_staticText102, 1, wxALL|wxFIXED_MINSIZE, 5 );
	
	wxString m_choice14Choices[] = { "Central RAM", "Bank RAM", "z80 mapping" };
	...
	x = new wxStaticText( m_panel16, wxID_ANY, "Central RAM", wxDefaultPosition, wxDefaultSize, 0 );
	x->Wrap( -1 );
	...
	y = new wxStaticText( m_panel16, wxID_ANY, "Bank RAM", wxDefaultPosition, wxDefaultSize, 0 );
	y->Wrap( -1 );
	...
	z = new wxStaticText( m_panel16, wxID_ANY, "ROM", wxDefaultPosition, wxDefaultSize, 0 );
	z->Wrap( -1 );
	...
	m_auinotebook1->AddPage( m_panel16, "Overview", false, wxNullBitmap );
	m_panel12 = new wxPanel( m_auinotebook1, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer51;
	bSizer51 = new wxBoxSizer( wxVERTICAL );
	
	m_staticText125 = new wxStaticText( m_panel12, wxID_ANY, "       00 01 02 03 04 05 06 07 08 09 0A 0B 0C 0D 0E 0F", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText125->Wrap( -1 );
	...
	m_radioBtn10 = new wxRadioButton( m_panel12, wxID_ANY, "hex", wxDefaultPosition, wxDefaultSize, 0 );
	m_radioBtn10->SetValue( true ); 
	bSizer52->Add( m_radioBtn10, 0, wxALL, 5 );
	
	m_radioBtn11 = new wxRadioButton( m_panel12, wxID_ANY, "dec", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer52->Add( m_radioBtn11, 0, wxALL, 5 );
	
	m_button82 = new wxButton( m_panel12, wxID_ANY, "Export...", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_auinotebook1->AddPage( m_panel12, "Explore", true, wxNullBitmap );
	...
	m_auinotebook1->AddPage( m_panel13, "Disassemble", false, wxNullBitmap );
	...
	m_staticText771 = new wxStaticText( m_panel19, wxID_ANY, "Load symbols from", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText771->Wrap( -1 );
	gbSizer2->Add( m_staticText771, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALL, 5 );
	
	m_filePicker9 = new wxFilePickerCtrl( m_panel19, wxID_ANY, wxEmptyString, "Select sjasmplus symbol file", "*.*", wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE|wxFLP_FILE_MUST_EXIST|wxFLP_OPEN );
	gbSizer2->Add( m_filePicker9, wxGBPosition( 0, 1 ), wxGBSpan( 1, 2 ), wxALL, 0 );
	
	m_staticText100 = new wxStaticText( m_panel19, wxID_ANY, "Search (ASCII)", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText100->Wrap( -1 );
	...
	m_button84 = new wxButton( m_panel19, wxID_ANY, "Search", wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer2->Add( m_button84, wxGBPosition( 1, 2 ), wxGBSpan( 1, 1 ), wxLEFT, 5 );
	
	m_staticText101 = new wxStaticText( m_panel19, wxID_ANY, "Search (number)", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText101->Wrap( -1 );
	...
	m_button85 = new wxButton( m_panel19, wxID_ANY, "Search", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_auinotebook1->AddPage( m_panel19, "Search", false, wxNullBitmap );
	...
	m_staticText77 = new wxStaticText( this, wxID_ANY, "Jump to", wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_button76 = new wxButton( this, wxID_ANY, "PC", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer39->Add( m_button76, 0, wxALL, 5 );
	
	m_button77 = new wxButton( this, wxID_ANY, "SP", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer39->Add( m_button77, 0, wxALL, 5 );
	
	wxString ChoiceLabelsChoices[] = { "(no symbol table loaded)" };
...
IDE::IDE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_menuItemNew = new wxMenuItem( m_menu6, wxID_ANY, wxString( "New" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu6->Append( m_menuItemNew );
	
	wxMenuItem* m_menuItemOpen;
	m_menuItemOpen = new wxMenuItem( m_menu6, wxID_ANY, wxString( "Open" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu6->Append( m_menuItemOpen );
	
	wxMenuItem* m_menuItemSave;
	m_menuItemSave = new wxMenuItem( m_menu6, wxID_ANY, wxString( "Save" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu6->Append( m_menuItemSave );
	
	wxMenuItem* m_menuItemSaveAs;
	m_menuItemSaveAs = new wxMenuItem( m_menu6, wxID_ANY, wxString( "Save as" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu6->Append( m_menuItemSaveAs );
	
	wxMenuItem* m_menuItemClose;
	m_menuItemClose = new wxMenuItem( m_menu6, wxID_ANY, wxString( "Close" ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_menuItemExit = new wxMenuItem( m_menu6, wxID_ANY, wxString( "Exit" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu6->Append( m_menuItemExit );
	
	m_menubar2->Append( m_menu6, "File" ); 
	
	m_menu10 = new wxMenu();
	m_menubar2->Append( m_menu10, "Edit" ); 
	
	m_menu11 = new wxMenu();
	wxMenuItem* m_menuAssemble;
	m_menuAssemble = new wxMenuItem( m_menu11, wxID_ANY, wxString( "Assemble" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu11->Append( m_menuAssemble );
	
	wxMenuItem* m_menuItem58;
	m_menuItem58 = new wxMenuItem( m_menu11, wxID_ANY, wxString( "Run" ) , wxEmptyString, wxITEM_NORMAL );
	...
	m_menuItem59 = new wxMenuItem( m_menu11, wxID_ANY, wxString( "Symbols" ) , wxEmptyString, wxITEM_NORMAL );
	m_menu11->Append( m_menuItem59 );
	
	m_menubar2->Append( m_menu11, "Assemble" ); 
...
DiscEditor::DiscEditor( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText97 = new wxStaticText( this, wxID_ANY, "Tracks", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText97->Wrap( -1 );
	...
	m_staticText98 = new wxStaticText( this, wxID_ANY, "Sides", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText98->Wrap( -1 );
	...
	wxString m_choice15Choices[] = { "Side A", "Side B" }; 
	int m_choice15NChoices = sizeof( m_choice15Choices ) / sizeof( wxString );
	m_choice15 = new wxChoice( m_panel17, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choice15NChoices, m_choice15Choices, 0 ); m_choice15->SetSelection( 0 );
	bSizer49->Add( m_choice15, 0, wxRIGHT, 5 );
	
	m_staticText119 = new wxStaticText( m_panel17, wxID_ANY, " Normal sector ", wxDefaultPosition, wxDefaultSize, 0|wxSIMPLE_BORDER );
	m_staticText119->Wrap( -1 );
	m_staticText119->SetBackgroundColour( wxColour( 255, 255, 255 ) );
	
	bSizer49->Add( m_staticText119, 0, wxEXPAND, 5 );
	
	m_staticText120 = new wxStaticText( m_panel17, wxID_ANY, " Weak ", wxDefaultPosition, wxDefaultSize, 0|wxSIMPLE_BORDER );
	m_staticText120->Wrap( -1 );
	m_staticText120->SetBackgroundColour( wxColour( 255, 0, 0 ) );
	
	bSizer49->Add( m_staticText120, 0, wxEXPAND, 5 );
	
	m_staticText121 = new wxStaticText( m_panel17, wxID_ANY, " Erased ", wxDefaultPosition, wxDefaultSize, 0|wxSIMPLE_BORDER );
	m_staticText121->Wrap( -1 );
	m_staticText121->SetBackgroundColour( wxColour( 0, 0, 255 ) );
	
	bSizer49->Add( m_staticText121, 0, wxEXPAND, 5 );
	
	m_staticText1211 = new wxStaticText( m_panel17, wxID_ANY, " Weak and erased ", wxDefaultPosition, wxDefaultSize, 0|wxSIMPLE_BORDER );
	...
	explorerPanel->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), 70, 90, 91, false, "Tahoma" ) );
	...
	DiskEd_Mode_Tabs->AddPage( m_panel17, "Explorer", false );
	...
	m_checkBox1 = new wxCheckBox( m_panel1, wxID_ANY, "Show System files", wxDefaultPosition, wxDefaultSize, 0 );
	bSizer50->Add( m_checkBox1, 0, wxALL, 5 );
	
	m_checkBox2 = new wxCheckBox( m_panel1, wxID_ANY, "Add/Remove Amsdos Header", wxDefaultPosition, wxDefaultSize, 0 );
	...
	DiskEd_Mode_Tabs->AddPage( m_panel1, "File System", false );
	...
	Track = new wxStaticText( m_panel2, wxID_ANY, "Track", wxDefaultPosition, wxDefaultSize, 0 );
	Track->Wrap( -1 );
	...
	m_staticText96 = new wxStaticText( m_panel2, wxID_ANY, "Sector", wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText96->Wrap( -1 );
	...
	m_menu9 = new wxMenu();
	wxMenuItem* m_menuItem61;
	m_menuItem61 = new wxMenuItem( m_menu9, wxID_ANY, wxString( "Cut" ) + '\t' + "CTRL+X", wxEmptyString, wxITEM_NORMAL );
	m_menu9->Append( m_menuItem61 );
	
	wxMenuItem* m_menuItem62;
	m_menuItem62 = new wxMenuItem( m_menu9, wxID_ANY, wxString( "Copy" ) + '\t' + "CTRL+C", wxEmptyString, wxITEM_NORMAL );
	m_menu9->Append( m_menuItem62 );
	
	wxMenuItem* m_menuItem63;
	m_menuItem63 = new wxMenuItem( m_menu9, wxID_ANY, wxString( "Paste" ) + '\t' + "CTRL+V", wxEmptyString, wxITEM_NORMAL );
	m_menu9->Append( m_menuItem63 );
	
	wxMenuItem* m_menuItem64;
	m_menuItem64 = new wxMenuItem( m_menu9, wxID_ANY, wxString( "Delete" ) + '\t' + "DEL", wxEmptyString, wxITEM_NORMAL );
	m_menu9->Append( m_menuItem64 );
	
	wxMenuItem* m_menuItem65;
	m_menuItem65 = new wxMenuItem( m_menu9, wxID_ANY, wxString( "Change ID" ) + '\t' + "CTRL+I", wxEmptyString, wxITEM_NORMAL );
	...
	st_size = new wxStaticText( m_panel2, wxID_ANY, "Size", wxDefaultPosition, wxDefaultSize, 0 );
	st_size->Wrap( -1 );
	bSizer43->Add( st_size, 0, wxLEFT|wxTOP, 5 );
	
	st_weak = new wxStaticText( m_panel2, wxID_ANY, "sane", wxDefaultPosition, wxDefaultSize, 0 );
	st_weak->Wrap( -1 );
	bSizer43->Add( st_weak, 0, wxLEFT|wxTOP, 5 );
	
	st_erased = new wxStaticText( m_panel2, wxID_ANY, "erased", wxDefaultPosition, wxDefaultSize, 0 );
	st_erased->Wrap( -1 );
	...
	DiskEd_Mode_Tabs->AddPage( m_panel2, "Sector Editor", true );
