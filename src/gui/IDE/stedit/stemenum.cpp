...
{
    wxCHECK_MSG(menuBar, false, "Invalid wxMenuBar");
...
{
    wxCHECK_MSG(tb, false, "Invalid toolbar");
    ...
    {
        if (tb->GetToolsCount()) tb->AddSeparator();
        wxSearchCtrl *searchCtrl = new wxSearchCtrl(tb, ID_STE_TOOLBAR_SEARCHCTRL, "", wxDefaultPosition, wxSize(200, -1), wxTE_PROCESS_ENTER);
