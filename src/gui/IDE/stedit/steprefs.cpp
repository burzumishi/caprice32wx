...
public:
    wxSTEditorPref_RefData()
    {
        ...
        m_lineNumberAutoWidth = -1;
    }

    wxArrayString m_prefs;
    wxString      m_lineNumberStyle;
    int           m_lineNumberAutoWidth;
};
...
void wxSTEditorPrefs::Init()
{
    ...
    wxASSERT_MSG(ID_STE_PREF__LAST-ID_STE_PREF__FIRST == STE_PREF__MAX - 1,
                 "The ID_STE_PREF_XXX count != STE_PREF_XXX count");

    s_STE_PrefNames.Alloc(STE_PREF__MAX);
    s_STE_PrefValues.Alloc(STE_PREF__MAX);
    s_STE_PrefFlags.Alloc(STE_PREF__MAX);

    AddInitPref("Highlight Syntax",    1, STE_PREF_FLAG_BOOL);
    AddInitPref("Highlight Preprocessor", 1, STE_PREF_FLAG_BOOL);
    AddInitPref("Highlight Braces",    1, STE_PREF_FLAG_BOOL);
    AddInitPref("Load Init Language",  1, STE_PREF_FLAG_BOOL);
    AddInitPref("Load Unicode",        STE_LOAD_DEFAULT, STE_PREF_FLAG_INT);
    AddInitPref("Wrap Mode",           wxSTC_WRAP_NONE, STE_PREF_FLAG_INT);
    AddInitPref("Wrap Visual Flags",   wxSTC_WRAPVISUALFLAG_END, STE_PREF_FLAG_INT);
    AddInitPref("Wrap Visual Flags Location", wxSTC_WRAPVISUALFLAGLOC_DEFAULT, STE_PREF_FLAG_INT);
    AddInitPref("Wrap Start Indent",   0, STE_PREF_FLAG_INT);
    AddInitPref("Zoom",                0, STE_PREF_FLAG_INT);
    AddInitPref("View EOL",            0, STE_PREF_FLAG_BOOL);
    AddInitPref("View Whitespace",     wxSTC_WS_INVISIBLE, STE_PREF_FLAG_INT);
    AddInitPref("Indent Guides",       1, STE_PREF_FLAG_BOOL);
    AddInitPref("Edge Mode",           wxSTC_EDGE_LINE, STE_PREF_FLAG_INT);
    AddInitPref("Edge Column",         80, STE_PREF_FLAG_INT);
    AddInitPref("View Line Margin",    0, STE_PREF_FLAG_BOOL);
    AddInitPref("View Marker Margin",  0, STE_PREF_FLAG_BOOL);
    AddInitPref("View Fold Margin",    1, STE_PREF_FLAG_BOOL);
    AddInitPref("Use Tabs",            0, STE_PREF_FLAG_BOOL);
    AddInitPref("Tab Indents",         1, STE_PREF_FLAG_BOOL);
    AddInitPref("Tab Width",           4, STE_PREF_FLAG_INT);
    AddInitPref("Indent Width",        4, STE_PREF_FLAG_INT);
    AddInitPref("BackSpace Unindents", 1, STE_PREF_FLAG_BOOL);
    AddInitPref("Auto Indent",         1, STE_PREF_FLAG_BOOL);
    AddInitPref("Caret Line Visible",  1, STE_PREF_FLAG_BOOL);
    AddInitPref("Caret Width",         1, STE_PREF_FLAG_INT);
    AddInitPref("Caret Period",        500, STE_PREF_FLAG_INT);
    AddInitPref("Caret Policy X",      wxSTC_CARET_EVEN|wxSTC_VISIBLE_STRICT|wxSTC_CARET_SLOP, STE_PREF_FLAG_INT);
    AddInitPref("Caret Policy Y",      wxSTC_CARET_EVEN|wxSTC_VISIBLE_STRICT|wxSTC_CARET_SLOP, STE_PREF_FLAG_INT);
    AddInitPref("Caret Slop X",        1, STE_PREF_FLAG_INT);
    AddInitPref("Caret Slop Y",        1, STE_PREF_FLAG_INT);
    AddInitPref("Visible Policy",      wxSTC_VISIBLE_STRICT|wxSTC_VISIBLE_SLOP, STE_PREF_FLAG_INT);
    AddInitPref("Visible Slop",        1, STE_PREF_FLAG_INT);
    AddInitPref("EOL Mode",
...
#endif
    AddInitPref("Selection mode",      -1, STE_PREF_FLAG_INT);
    AddInitPref("Print Magnification", -2, STE_PREF_FLAG_INT);
    AddInitPref("Print Colour Mode",   wxSTC_PRINT_COLOURONWHITE, STE_PREF_FLAG_INT);
    AddInitPref("Print Wrap Mode",     wxSTC_WRAP_WORD, STE_PREF_FLAG_INT);
    AddInitPref("Print Linenumbers",   STE_PRINT_LINENUMBERS_DEFAULT, STE_PREF_FLAG_INT);
    AddInitPref("Fold Flags",          wxSTC_FOLDFLAG_LINEBEFORE_CONTRACTED|wxSTC_FOLDFLAG_LINEAFTER_CONTRACTED, STE_PREF_FLAG_INT); //wxSTC_FOLDFLAG_LEVELNUMBERS
    AddInitPref("Fold Styles",         STE_FOLD_STYLE_DEFAULT, STE_PREF_FLAG_INT);
    AddInitPref("Fold Margin Style",   STE_FOLDMARGIN_STYLE_SQUARES, STE_PREF_FLAG_INT);
    AddInitPref("Buffered Draw",       1, STE_PREF_FLAG_BOOL);
    AddInitPref("Two Phase Draw",      0, STE_PREF_FLAG_BOOL);
    // DO NOT USE page cache in wxWidgets < 2.5.4, leads to a crash eventually Need Scintilla 1.61
    AddInitPref("Layout Cache",
                                            wxSTC_CACHE_PAGE, STE_PREF_FLAG_INT);
    AddInitPref("Use Antialiasing",    1,                STE_PREF_FLAG_BOOL);

    AddInitPref("Save Remove Trailing Whitespace", 0,    STE_PREF_FLAG_BOOL);
    AddInitPref("Save Convert EOL",                0,    STE_PREF_FLAG_BOOL);


    AddInitPref("Horizontal Scrollbar", 1,                 STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Vertical Scrollbar",   1,                 STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin0 Type",       wxSTC_MARGIN_NUMBER, STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin1 Type",       wxSTC_MARGIN_SYMBOL, STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin2 Type",       wxSTC_MARGIN_SYMBOL, STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin0 Width",      -1,                  STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin1 Width",      16,                  STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin2 Width",      16,                  STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin0 Mask",       0,                   STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin1 Mask",       ~wxSTC_MASK_FOLDERS, STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin2 Mask",       wxSTC_MASK_FOLDERS,  STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin0 Sensitive",  0,                   STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin1 Sensitive",  1,                   STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Margin2 Sensitive",  1,                   STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);

    AddInitPref("Bookmark Margin1 DClick",  1,             STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);

    AddInitPref("Auto Completion Stops",             " ()[]{}<>:;.?", STE_PREF_FLAG_STRING|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Auto Completion Separator",         int(' '),      STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Auto Completion FillUps",           wxEmptyString, STE_PREF_FLAG_STRING|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Auto Completion Cancel at Start",   1,             STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Auto Completion Choose Single",     1,             STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Auto Completion Ignore Case",       0,             STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Auto Completion Auto Hide",         1,             STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Auto Completion Drop Rest of Word", 1,             STE_PREF_FLAG_BOOL|STE_PREF_FLAG_NOCONFIG);
    AddInitPref("Auto Completion Type Separator",    int('?'),      STE_PREF_FLAG_INT|STE_PREF_FLAG_NOCONFIG);
...
wxString wxSTEditorPrefs::GetPrefName(size_t pref_n) const
{
    wxCHECK_MSG(pref_n < GetInitPrefCount(), wxEmptyString,
                "Invalid pref id in wxSTEditorPrefs::GetPrefName");
...
void wxSTEditorPrefs::SetPrefName(size_t pref_n, const wxString& prefName)
{
    wxCHECK_RET(pref_n < GetInitPrefCount(),
        "Invalid pref id in wxSTEditorPrefs::SetPrefName");
...
int wxSTEditorPrefs::GetPrefFlags(size_t pref_n) const
{
    wxCHECK_MSG(pref_n < GetInitPrefCount(), 0,
                "Invalid pref id in wxSTEditorPrefs::GetPrefFlags");
    return s_STE_PrefFlags[pref_n];
}
void wxSTEditorPrefs::SetPrefFlags(size_t pref_n, int flags)
{
    wxCHECK_RET(pref_n < GetInitPrefCount(),
                "Invalid pref id in wxSTEditorPrefs::SetPrefFlags");
...
{
    return AddInitPref(prefName, wxString::Format("%d", value), flags);
}
...
{
    wxCHECK_MSG(editor, false, "Invalid editor in wxSTEditorPrefs::Create");
    ...
    view = (editor->GetMarginType(STE_MARGIN_FOLD) == wxSTC_MARGIN_SYMBOL) &&
           (editor->GetMarginMask(STE_MARGIN_FOLD) == (int)wxSTC_MASK_FOLDERS) &&
...
{
    wxCHECK_RET(other.IsOk(), "Prefs not created");
    if (!IsOk()) Create();
...
{
    wxCHECK_RET(IsOk(), "Prefs not created");
    Create();
}

bool wxSTEditorPrefs::IsEqualTo(const wxSTEditorPrefs &prefs) const
{
    wxCHECK_MSG(IsOk() && prefs.IsOk(), false, "Prefs not created");
...
{
    return SetPref(pref_n, wxString::Format("%d", value), update);
}
...
{
    wxCHECK_RET(IsOk(), "Prefs not created");
    wxCHECK_RET(editor, "Invalid wxSTEditor");

    // STE_PREF_SYNTAXHILIGHT  done in langs

    if (!HasPrefFlag(STE_PREF_HIGHLIGHT_PREPROC, STE_PREF_FLAG_IGNORE))
        editor->SetProperty("styling.within.preprocessor",
                            GetPrefBool(STE_PREF_HIGHLIGHT_PREPROC) ? "1" : "0");
    ...
    if (!HasPrefFlag(STE_PREF_FOLD_STYLES, STE_PREF_FLAG_IGNORE))
    {
        ...
        editor->SetProperty("fold.compact",           STE_HASBIT(fold_style, STE_FOLD_COMPACT)   ? "1" : "0");
        editor->SetProperty("fold.comment",           STE_HASBIT(fold_style, STE_FOLD_COMMENT)   ? "1" : "0");
        editor->SetProperty("fold.preprocessor",      STE_HASBIT(fold_style, STE_FOLD_PREPROC)   ? "1" : "0");
        editor->SetProperty("fold.at.else",           STE_HASBIT(fold_style, STE_FOLD_ATELSE)    ? "1" : "0");
        editor->SetProperty("fold.html",              STE_HASBIT(fold_style, STE_FOLD_HTML)      ? "1" : "0");
        editor->SetProperty("fold.html.preprocessor", STE_HASBIT(fold_style, STE_FOLD_HTMLPREP)  ? "1" : "0");
        editor->SetProperty("fold.directive",         STE_HASBIT(fold_style, STE_FOLD_DIRECTIVE) ? "1" : "0");
        editor->SetProperty("fold.comment.python",    STE_HASBIT(fold_style, STE_FOLD_COMMENTPY) ? "1" : "0");
        editor->SetProperty("fold.quotes.python",     STE_HASBIT(fold_style, STE_FOLD_QUOTESPY)  ? "1" : "0");
        editor->SetProperty("tab.timmy.whinge.level", STE_HASBIT(fold_style, STE_FOLD_TABTIMMY)  ? "1" : "0");
    }
    ...
    // The wxSTC::TextWidth is a very expensive operation. Avoid if possible.
    if ((margin0_width < 0) || (margin1_width < 0) || (margin2_width < 0))
    {
             ...
             M_PREFDATA->m_lineNumberStyle))
        {
            ...
            M_PREFDATA->m_lineNumberAutoWidth = editor->TextWidth(wxSTC_STYLE_LINENUMBER, "_999999");
        }

        if (margin0_width < 0) margin0_width = M_PREFDATA->m_lineNumberAutoWidth;
        if (margin1_width < 0) margin1_width = M_PREFDATA->m_lineNumberAutoWidth;
        if (margin2_width < 0) margin2_width = M_PREFDATA->m_lineNumberAutoWidth;
    }
