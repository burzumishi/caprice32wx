...
void wxSTEditorStyles::Init()
{
    ...
    keyArr.Add(STE_STYLE_DEFAULT);           valArr.Add(wxSTEditorStyle("Default text",       0x000000, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, 0,                                 STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_KEYWORD1);          valArr.Add(wxSTEditorStyle("Keyword 1",          0x0000FF, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFONTSTYLE,  STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_KEYWORD2);          valArr.Add(wxSTEditorStyle("Keyword 2",          0x0000AA, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_KEYWORD3);          valArr.Add(wxSTEditorStyle("Keyword 3",          0x42426F, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_KEYWORD4);          valArr.Add(wxSTEditorStyle("Keyword 4",          0xAA00AA, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_KEYWORD5);          valArr.Add(wxSTEditorStyle("Keyword 5",          0x2F2F2F, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_KEYWORD6);          valArr.Add(wxSTEditorStyle("Keyword 6",          0x808080, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_COMMENT);           valArr.Add(wxSTEditorStyle("Comment",            0x238E23, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_COMMENTDOC);        valArr.Add(wxSTEditorStyle("Comment doc",        0x238E23, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_COMMENTLINE);       valArr.Add(wxSTEditorStyle("Comment line",       0x238E23, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_COMMENTOTHER);      valArr.Add(wxSTEditorStyle("Comment other",      0x238E23, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_CHARACTER);         valArr.Add(wxSTEditorStyle("Character",          0x9F9F9F, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_CHARACTEREOL);      valArr.Add(wxSTEditorStyle("Character EOL",      0x9F9F9F, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_STRING);            valArr.Add(wxSTEditorStyle("String",             0x2AA52A, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_STRINGEOL);         valArr.Add(wxSTEditorStyle("String EOL",         0x2AA52A, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_DELIMITER);         valArr.Add(wxSTEditorStyle("Delimiter",          0xCC3232, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_PUNCTUATION);       valArr.Add(wxSTEditorStyle("Punctuation",        0xCC3232, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_OPERATOR);          valArr.Add(wxSTEditorStyle("Operator",           0x000000, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_BRACE);             valArr.Add(wxSTEditorStyle("Brace",              0x4F2F4F, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_COMMAND);           valArr.Add(wxSTEditorStyle("Command",            0x0000FF, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_IDENTIFIER);        valArr.Add(wxSTEditorStyle("Identifier",         0x000000, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_LABEL);             valArr.Add(wxSTEditorStyle("Label",              0x4F2F4F, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_NUMBER);            valArr.Add(wxSTEditorStyle("Number",             0x238E6B, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_PARAMETER);         valArr.Add(wxSTEditorStyle("Parameter",          0x4F2F4F, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_REGEX);             valArr.Add(wxSTEditorStyle("Regular expression", 0xDB70DB, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_UUID);              valArr.Add(wxSTEditorStyle("UUID",               0xDB70DB, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_VALUE);             valArr.Add(wxSTEditorStyle("Value",              0xDB70DB, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_PREPROCESSOR);      valArr.Add(wxSTEditorStyle("Preprocessor",       0x808080, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_SCRIPT);            valArr.Add(wxSTEditorStyle("Script",             0x2F2F2F, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_ERROR);             valArr.Add(wxSTEditorStyle("Error",              0xFF0000, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_UNDEFINED);         valArr.Add(wxSTEditorStyle("Undefined",          0x32CC32, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    //keyArr.Add(STE_STYLE_UNUSED);          valArr.Add(wxSTEditorStyle("Unused",             0x000000, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_ALL,          STE_STYLE_USES_ALL));
    //keyArr.Add(wxSTC_STYLE_DEFAULT);       valArr.Add(wxSTEditorStyle("Editor default",     0x000000, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_ALL,          STE_STYLE_USES_ALL));

    keyArr.Add(STE_STYLE_LINENUMBER);        valArr.Add(wxSTEditorStyle("Line numbers",       0x000000, 0xC0C0C0, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOCOLOUR,     STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_BRACELIGHT);        valArr.Add(wxSTEditorStyle("Brace hilight",      0x0000FF, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_BRACEBAD);          valArr.Add(wxSTEditorStyle("Brace mismatch",     0xFF0000, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_CONTROLCHAR);       valArr.Add(wxSTEditorStyle("Control character",  0x000000, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_ALL));
    keyArr.Add(STE_STYLE_INDENTGUIDE);       valArr.Add(wxSTEditorStyle("Indent guide",       0x808080, 0xFFFFFF, STE_DEFAULT_FONT_FACENAME, STE_DEFAULT_FONT_SIZE, 0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_COLOUR));

    keyArr.Add(STE_STYLE_SELECTION_COLOUR);  valArr.Add(wxSTEditorStyle("Selection colour",   0xFFFFFF, 0xC0C0C0, wxEmptyString,    0,                0, STE_STYLE_USEDEFAULT_NOCOLOUR,     STE_STYLE_USES_COLOUR));
    keyArr.Add(STE_STYLE_WHITESPACE_COLOUR); valArr.Add(wxSTEditorStyle("Whitespace colour",  0x000000, 0xFFFFFF, wxEmptyString,    0,                0, STE_STYLE_USEDEFAULT_ALL,          STE_STYLE_USES_COLOUR));
    keyArr.Add(STE_STYLE_EDGE_COLOUR);       valArr.Add(wxSTEditorStyle("Edge colour",        0xC0C0C0, 0xFFFFFF, wxEmptyString,    0,                0, STE_STYLE_USEDEFAULT_NOFORECOLOUR, STE_STYLE_USES_FORECOLOUR));
    keyArr.Add(STE_STYLE_CARET_COLOUR);      valArr.Add(wxSTEditorStyle("Caret colour",       0x000000, 0xF9F9F9, wxEmptyString,    0,                0, STE_STYLE_USEDEFAULT_NOCOLOUR,     STE_STYLE_USES_COLOUR));
    keyArr.Add(STE_STYLE_FOLD_COLOUR);       valArr.Add(wxSTEditorStyle("Fold margin colour", 0xE0E0E0, 0xFFFFFF, wxEmptyString,    0,                0, STE_STYLE_USEDEFAULT_NOCOLOUR,     STE_STYLE_USES_COLOUR));

    // defaults same as Scintilla's defaults
    keyArr.Add(STE_STYLE_INDIC_0);           valArr.Add(wxSTEditorStyle("Indicator 0",        0x007F00, 0xFFFFFF, wxEmptyString, 0, wxSTC_INDIC_SQUIGGLE, STE_STYLE_USEDEFAULT_NOFONTSTYLE, STE_STYLE_USES_FORECOLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_INDIC_1);           valArr.Add(wxSTEditorStyle("Indicator 1",        0x0000FF, 0xFFFFFF, wxEmptyString, 0, wxSTC_INDIC_TT,       STE_STYLE_USEDEFAULT_NOFONTSTYLE, STE_STYLE_USES_FORECOLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_INDIC_2);           valArr.Add(wxSTEditorStyle("Indicator 2",        0xFF0000, 0xFFFFFF, wxEmptyString, 0, wxSTC_INDIC_PLAIN,    STE_STYLE_USEDEFAULT_NOFONTSTYLE, STE_STYLE_USES_FORECOLOUR|STE_STYLE_USES_STYLE));

    // make sure that these are in order
    keyArr.Add(STE_STYLE_MARKER_BOOKMARK);      valArr.Add(wxSTEditorStyle("Bookmark marker",             0x000000, 0x33AA55, wxEmptyString, 0, wxSTC_MARK_ROUNDRECT,         STE_STYLE_USEDEFAULT_NOFONTSTYLE & STE_STYLE_USEDEFAULT_NOCOLOUR, STE_STYLE_USES_COLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_MARKER_FOLDEREND);     valArr.Add(wxSTEditorStyle("Folder End Marker",           0xFFFFFF, 0x808080, wxEmptyString, 0, wxSTC_MARK_BOXPLUSCONNECTED,  STE_STYLE_USEDEFAULT_NOFONTSTYLE & STE_STYLE_USEDEFAULT_NOCOLOUR, STE_STYLE_USES_COLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_MARKER_FOLDEROPENMID); valArr.Add(wxSTEditorStyle("Folder Open Mid Marker",      0xFFFFFF, 0x808080, wxEmptyString, 0, wxSTC_MARK_BOXMINUSCONNECTED, STE_STYLE_USEDEFAULT_NOFONTSTYLE & STE_STYLE_USEDEFAULT_NOCOLOUR, STE_STYLE_USES_COLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_MARKER_FOLDERMIDTAIL); valArr.Add(wxSTEditorStyle("Folder Open Mid Tail Marker", 0xFFFFFF, 0x808080, wxEmptyString, 0, wxSTC_MARK_TCORNER,           STE_STYLE_USEDEFAULT_NOFONTSTYLE & STE_STYLE_USEDEFAULT_NOCOLOUR, STE_STYLE_USES_COLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_MARKER_FOLDERTAIL);    valArr.Add(wxSTEditorStyle("Folder Tail Marker",          0xFFFFFF, 0x808080, wxEmptyString, 0, wxSTC_MARK_LCORNER,           STE_STYLE_USEDEFAULT_NOFONTSTYLE & STE_STYLE_USEDEFAULT_NOCOLOUR, STE_STYLE_USES_COLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_MARKER_FOLDERSUB);     valArr.Add(wxSTEditorStyle("Folder Sub Marker",           0xFFFFFF, 0x808080, wxEmptyString, 0, wxSTC_MARK_VLINE,             STE_STYLE_USEDEFAULT_NOFONTSTYLE & STE_STYLE_USEDEFAULT_NOCOLOUR, STE_STYLE_USES_COLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_MARKER_FOLDER);        valArr.Add(wxSTEditorStyle("Folder Marker",               0xFFFFFF, 0x808080, wxEmptyString, 0, wxSTC_MARK_BOXPLUS,           STE_STYLE_USEDEFAULT_NOFONTSTYLE & STE_STYLE_USEDEFAULT_NOCOLOUR, STE_STYLE_USES_COLOUR|STE_STYLE_USES_STYLE));
    keyArr.Add(STE_STYLE_MARKER_FOLDEROPEN);    valArr.Add(wxSTEditorStyle("Folder Open Marker",          0xFFFFFF, 0x808080, wxEmptyString, 0, wxSTC_MARK_BOXMINUS,          STE_STYLE_USEDEFAULT_NOFONTSTYLE & STE_STYLE_USEDEFAULT_NOCOLOUR, STE_STYLE_USES_COLOUR|STE_STYLE_USES_STYLE));

#if defined(__WXDEBUG__)
    for (size_t n = 1; n < keyArr.GetCount(); n++) wxCHECK_RET(keyArr[n-1] < keyArr[n], "styles are initialized out of order");
#endif // defined(__WXDEBUG__)
}

int wxSTEditorStyles::wxColourToInt(const wxColour& c) const
{
    wxCHECK_MSG(c.IsOk(), 0, "Invalid colour in wxSTEditorStyles::wxColourToInt");
...
{
    wxCHECK_RET(other.IsOk(), "Styles not created");
    if (!IsOk()) Create();
...
{
    wxCHECK_RET(IsOk(), "Styles not created");
...
{
    wxCHECK_MSG(IsOk() && styles.IsOk(), false, "Styles not created");
...
{
    wxCHECK_MSG(IsOk(), wxNOT_FOUND, "Styles not created");
...
{
    wxArrayInt styles;
    wxCHECK_MSG(IsOk(), styles, "Styles not created");
...
{
    wxCHECK_MSG(IsOk(), NULL, "Styles not created");
    int n = FindNthStyle(style_n);

    if (n != wxNOT_FOUND)
        return &M_STYLEDATA->m_pairArrayStyles.ItemValue(n);

    wxFAIL_MSG("Unknown style in wxSTEditorStyles::GetStyle");
...
{
    wxCHECK_MSG(IsOk(), wxFont(STE_DEFAULT_FONT_SIZE, wxMODERN, wxNORMAL, wxNORMAL), "Styles not created");
/*
...
{
    wxCHECK_MSG(IsOk(), false, "Styles not created");
...
{
    wxCHECK_RET(IsOk(), "Styles not created");
    wxCHECK_RET(font.IsOk(), "Invalid font");
...
void wxSTEditorStyles::SetCase(int style_n, int lcase)
{
    ...
    wxCHECK_RET(steCase != -1, "Invalid letter case for style");
...
{
    wxCHECK_RET(IsOk(), "Styles not created");
    wxCHECK_RET(HasStyle(ste_style), "Invalid STE style");
    wxCHECK_RET(editor, "Invalid editor");
...
{
    wxCHECK_MSG(IsOk(), wxEmptyString, "Styles not created");
...
wxString wxSTEditorStyles::ParseConfigLine(const wxString &key, const wxString &value)
{
    ...
    if (style_n == -1)
        return _("Unknown style name in '")+name+"'\n";

    for (wxStringTokenizer tkz(value, ",");
         tkz.HasMoreTokens();
         )
    {
        wxString token = tkz.GetNextToken();
        option = token.BeforeFirst(':').Strip(wxString::both);
        val = token.AfterFirst(':').Strip(wxString::both);

        if (val.IsEmpty())
        {
            errorMsg += _("Empty style option '") + option + _("' in style '")+name+"'\n";
            continue;
        }
        bool def = (val.GetChar(0) == '*');
        if (def)
            val = val.AfterFirst('*').Strip(wxString::leading);
        ...
        if (option == "fore")
        {
            if (val.ToLong(&long_val, 16))
            {
                ...
                errorMsg += _("Invalid foreground colour in style '")+name+"'\n";
        }
        else if (option == "back")
        {
            if (val.ToLong(&long_val, 16))
            {
                ...
                errorMsg += _("Invalid background colour in style '")+name+"'\n";
        }
        else if (option == "face")
        {
        ...
        else if (option == "size")
        {
            if (val.ToLong(&long_val))
            {
                ...
                errorMsg += _("Invalid font size in style '")+name+"'\n";
        }
        else if (option == "bold")
        {
            SetUseDefault(style_n, STE_STYLE_USEDEFAULT_FONTSTYLE, def);
            SetBold(style_n, val != "0");
        }
        else if (option == "italic")
        {
            //SetUseDefault(style_n, STE_STYLE_USEDEFAULT_FONTSTYLE, def);
            SetItalic(style_n, val != "0");
        }
        else if (option == "underline")
        {
            //SetUseDefault(style_n, STE_STYLE_USEDEFAULT_FONTSTYLE, def);
            SetUnderlined(style_n, val != "0");
        }
        ...
        {
            //SetUseDefault(style_n, STE_STYLE_USEDEFAULT_FONTSTYLE, def);
            SetEOLFilled(style_n, val != "0");
        }
        else if (option == "hotspot")
        {
            //SetUseDefault(style_n, STE_STYLE_USEDEFAULT_FONTSTYLE, def);
            SetHotSpot(style_n, val != "0");
        }
        else if (option == "case")
        {
            if (val.ToLong(&long_val) &&
                ((long_val == wxSTC_CASE_MIXED)||(long_val == wxSTC_CASE_UPPER)||(long_val == wxSTC_CASE_LOWER)))
            {
                ...
                errorMsg += _("Invalid letter case for style '")+name+"'.\n";
        }
        else if (option == "style") // only for indicators & markers
        {
            if ((style_n >= STE_STYLE_INDIC__FIRST) && (style_n <= STE_STYLE_INDIC__LAST))
            {
                if (val.ToLong(&long_val) && (long_val >= 0) && (long_val < wxSTC_INDIC_MAX))
                {
                    ...
                    errorMsg += _("Invalid indicator style in '")+name+"'\n";
            }
            else if ((style_n >= STE_STYLE_MARKER__FIRST) && (style_n <= STE_STYLE_MARKER__LAST))
            {
                if (val.ToLong(&long_val) && (long_val >= 0)) // && (long_val < wxSTC_MARKER_MAX))
                {
                    ...
                    errorMsg += _("Invalid marker style in '")+name+"'\n";
            }
            else
            {
                errorMsg += _("Style set for non indicator or marker in '")+name+"'\n";
            }
        }
    }
...
#define BOOL_CFG(val) ((val) ? wxString("1") : wxString("0"))
...
{
    wxCHECK_MSG(IsOk(), wxEmptyString, "Styles not created");
    wxString line; // = wxString::Format("type:%d,", n);

    if (GetStyleUses(n, STE_STYLE_USES_FORECOLOUR))
        line += "fore:" + DEF_CFG(STE_STYLE_USEDEFAULT_FORECOLOUR) + wxString::Format("0x%06X", GetForegroundColourInt(n)) + ",";
    if (GetStyleUses(n, STE_STYLE_USES_BACKCOLOUR))
        line += "back:" + DEF_CFG(STE_STYLE_USEDEFAULT_BACKCOLOUR) + wxString::Format("0x%06X", GetBackgroundColourInt(n)) + ",";

    if (GetStyleUses(n, STE_STYLE_USES_FACENAME))
        line += "face:"      + DEF_CFG(STE_STYLE_USEDEFAULT_FACENAME)  + GetFaceName(n) + ",";
    if (GetStyleUses(n, STE_STYLE_USES_FONTSIZE))
        line += "size:"      + DEF_CFG(STE_STYLE_USEDEFAULT_FONTSIZE)  + wxString::Format("%d,", GetSize(n));
    if (GetStyleUses(n, STE_STYLE_USES_FONTSTYLE))
    {
        line += "bold:"      + DEF_CFG(STE_STYLE_USEDEFAULT_FONTSTYLE) + BOOL_CFG(GetBold(n)) + ",";
        line += "italic:"    + DEF_CFG(STE_STYLE_USEDEFAULT_FONTSTYLE) + BOOL_CFG(GetItalic(n)) + ",";
        line += "underline:" + DEF_CFG(STE_STYLE_USEDEFAULT_FONTSTYLE) + BOOL_CFG(GetUnderlined(n)) + ",";
        line += "eol:"       + DEF_CFG(STE_STYLE_USEDEFAULT_FONTSTYLE) + BOOL_CFG(GetEOLFilled(n)) + ",";
        line += "hotspot:"   + DEF_CFG(STE_STYLE_USEDEFAULT_FONTSTYLE) + BOOL_CFG(GetHotSpot(n)) + ",";
        line += "case:"      + wxString::Format("%d", GetCase(n));
    }
    else if (GetStyleUses(n, STE_STYLE_USES_STYLE))
    {
        line += "style:" + wxString::Format("%d", GetFontAttr(n)); // style stored here
    }

    if ((line.Length() > 0u) && (line.Last() == ','))
