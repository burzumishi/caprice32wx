...
wxWindow *item4 = item5;
    ...
    wxSpinCtrl *item14 = new wxSpinCtrl( parent, ID_STEDLG_FONTSIZE_SPINCTRL, "12", wxDefaultPosition, wxSize(75,-1), wxSP_ARROW_KEYS, 4, 48, 12 );
...
wxSizer *wxSTEditorLangSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxTextCtrl *item7 = new wxTextCtrl( parent, ID_STEDLG_FILEPATTERN_TEXTCTRL, "", wxDefaultPosition, wxDefaultSize, 0 );
...
wxSizer *wxSTEditorFindReplaceSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxComboBox *item5 = new wxComboBox( parent, ID_STEDLG_FIND_COMBO, "", wxDefaultPosition, wxSize(250,-1), 11, strs5, wxCB_DROPDOWN );
    ...
    wxComboBox *item8 = new wxComboBox( parent, ID_STEDLG_REPLACE_COMBO, "", wxDefaultPosition, wxSize(250,-1), 11, strs8, wxCB_DROPDOWN );
...
wxSizer *wxSTEditorInsertTextSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxSpinCtrl *item5 = new wxSpinCtrl( parent, ID_STEDLG_INSERT_COLUMN_SPINCTRL, "1", wxDefaultPosition, wxSize(100,-1), wxSP_ARROW_KEYS, 1, 1000, 1 );
    ...
    wxComboBox *item9 = new wxComboBox( parent, ID_STEDLG_INSERT_PREPEND_COMBO, "", wxDefaultPosition, wxSize(100,-1), 6, strs9, wxCB_DROPDOWN );
    ...
    wxComboBox *item12 = new wxComboBox( parent, ID_STEDLG_INSERT_APPEND_COMBO, "", wxDefaultPosition, wxSize(100,-1), 6, strs12, wxCB_DROPDOWN );
...
wxSizer *wxSTEditorViewPrefsSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxSpinCtrl *item5 = new wxSpinCtrl( parent, ID_STEDLG_ZOOM_SPINCTRL, "0", wxDefaultPosition, wxSize(60,-1), wxSP_ARROW_KEYS, -10, 20, 0 );
    ...
    wxSpinCtrl *item12 = new wxSpinCtrl( parent, ID_STEDLG_EDGE_COLUMN_SPINCTRL, "80", wxDefaultPosition, wxSize(60,-1), wxSP_ARROW_KEYS, 0, 255, 80 );
    ...
    wxSpinCtrl *item22 = new wxSpinCtrl( parent, ID_STEDLG_CARET_WIDTH_SPINCTRL, "1", wxDefaultPosition, wxSize(60,-1), wxSP_ARROW_KEYS, 1, 3, 1 );
    ...
    wxSpinCtrl *item24 = new wxSpinCtrl( parent, ID_STEDLG_CARET_PERIOD_SPINCTRL, "500", wxDefaultPosition, wxSize(60,-1), wxSP_ARROW_KEYS, 0, 2000, 500 );
...
wxSizer *wxSTEditorPrintPrefsSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxSpinCtrl *item7 = new wxSpinCtrl( parent, ID_STEDLG_PRINT_MAGNIFICATION_SPINCTRL, "-2", wxDefaultPosition, wxSize(70,-1), wxSP_ARROW_KEYS, -20, 20, -2 );
    ...
    wxCheckBox *item9 = new wxCheckBox( parent, ID_STEDLG_PRINT_WRAPMODE_CHECKBOX, "", wxDefaultPosition, wxDefaultSize, 0 );
...
wxSizer *wxSTEditorTabsPrefsSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxSpinCtrl *item6 = new wxSpinCtrl( parent, ID_STEDLG_TAB_WIDTH_SPINCTRL, "4", wxDefaultPosition, wxSize(60,-1), wxSP_ARROW_KEYS, 0, 32, 4 );
    ...
    wxSpinCtrl *item12 = new wxSpinCtrl( parent, ID_STEDLG_INDENT_WIDTH_SPINCTRL, "4", wxDefaultPosition, wxSize(60,-1), wxSP_ARROW_KEYS, 0, 32, 4 );
...
wxSizer *wxSTEditorFoldPrefsSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxSpinCtrl *item17 = new wxSpinCtrl( parent, ID_STEDLG_WRAP_STARTINDENT_SPINCTRL, "0", wxDefaultPosition, wxSize(60,-1), wxSP_ARROW_KEYS, 0, 100, 0 );
...
wxSizer *wxSTEditorColumnizeSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxComboBox *item3 = new wxComboBox( parent, ID_STEDLG_COLUMNIZE_BEFORE_COMBO, "", wxDefaultPosition, wxSize(100,-1), 11, strs3, wxCB_DROPDOWN );
    ...
    wxComboBox *item6 = new wxComboBox( parent, ID_STEDLG_COLUMNIZE_AFTER_COMBO, "", wxDefaultPosition, wxSize(100,-1), 11, strs6, wxCB_DROPDOWN );
    ...
    wxComboBox *item9 = new wxComboBox( parent, ID_STEDLG_COLUMNIZE_PRESERVE_COMBO, "", wxDefaultPosition, wxSize(100,-1), 11, strs9, wxCB_DROPDOWN );
    ...
    wxComboBox *item12 = new wxComboBox( parent, ID_STEDLG_COLUMNIZE_IGNORE_COMBO, "", wxDefaultPosition, wxSize(100,-1), 1, strs12, wxCB_DROPDOWN );
...
wxSizer *wxSTEditorExportSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxComboBox *item5 = new wxComboBox( parent, ID_STEDLG_EXPORT_FILENAME_COMBO, "", wxDefaultPosition, wxDefaultSize, 6, strs5, wxCB_DROPDOWN );
    item1->Add( item5, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5 );
...
wxSizer *wxSTEditorLangKeywordSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxTextCtrl *item8 = new wxTextCtrl( parent, ID_STEDLG_LANG_KEYWORD_TEXTCTRL, "", wxDefaultPosition, wxSize(80,40), wxTE_MULTILINE|wxTE_READONLY );
    item5->Add( item8, 0, wxGROW|wxALL, 5 );

    wxTextCtrl *item9 = new wxTextCtrl( parent, ID_STEDLG_LANG_USERKEYWORD_TEXTCTRL, "", wxDefaultPosition, wxSize(80,40), wxTE_MULTILINE );
