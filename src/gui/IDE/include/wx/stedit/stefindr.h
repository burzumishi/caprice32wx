...
public:
    ...
    bool LoadConfig(wxConfigBase &config,
                    const wxString &configPath = "/wxSTEditor/FindReplace/");
    void SaveConfig(wxConfigBase &config,
                    const wxString &configPath = "/wxSTEditor/FindReplace/") const;
...
public:
    ...
    wxSTEditorFindResultsEditor(wxWindow *parent, wxWindowID winid,
                                ...
                                long style = 0,
                                const wxString& name = "wxSTEditorFindResultsEditor")
    {
        Init();
...
public:
    ...
    wxSTEditorFindReplacePanel(wxWindow *parent, wxWindowID winid,
                               ...
                               const wxString& name = "wxSTEditorFindReplacePanel")
    {
        Init();
