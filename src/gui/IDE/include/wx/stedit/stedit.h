...
public:
    ...
    ~wxSTERecursionGuard()
    {
        wxASSERT_MSG(m_flag.m_flag > 0, "unbalanced wxSTERecursionGuards!?");
        m_flag.m_flag--;
    }
...
public:
    ...
    {
        wxCHECK_MSG(lang >= 0, false, "Invalid language ID");
        m_steLang_id = lang;
        return true;
    }
...
public :
    ...
    wxSTEditor(wxWindow *parent, wxWindowID id = wxID_ANY,
               ...
               const wxString& name = "wxSTEditor");
    ...
    virtual wxSTEditor* Clone(wxWindow *parent, wxWindowID id = wxID_ANY,
                              ...
                              const wxSize& size = wxDefaultSize,
                              long style = 0, // wxStyledTextCtrl ors this with defaults
                              const wxString& name = "wxSTEditor") const;
    ...
    bool RemoveCharsAroundPos(STE_TextPos pos = -1, const wxString& remove = " \t");
    ...
    bool Columnize(int top_line = -1, int bottom_line = -1,
                   const wxString& splitBefore   = ")]{}",
                   const wxString& splitAfter    = ",;",
