...
class EmulatorWindow : public wxFrame 
{
	...
	protected:
		...
		virtual void drawPanel( wxPaintEvent& event ) { event.Skip(); }
		virtual void paintFDCLed( wxPaintEvent& event ) { event.Skip(); }
		
	
	public:
		
		EmulatorWindow( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "Caprice32Reloaded", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxCAPTION|wxCLOSE_BOX|wxMINIMIZE_BOX|wxSYSTEM_MENU|wxWANTS_CHARS, const wxString& name = "CapriceMainWindow" );
		~EmulatorWindow();
...
class Settings : public wxDialog 
{
	...
	public:
		...
		Settings( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "Caprice Reloaded Settings", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxCAPTION|wxCLOSE_BOX|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxSYSTEM_MENU|wxWANTS_CHARS );
		~Settings();
...
class FileProperties : public wxDialog 
{
	...
	public:
		...
		FileProperties( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "Properties", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 411,367 ), long style = wxDEFAULT_DIALOG_STYLE );
		~FileProperties();
...
class About : public wxDialog 
{
	...
	public:
		...
		About( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "About Caprice32Reloaded", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( -1,-1 ), long style = wxDEFAULT_DIALOG_STYLE );
		~About();
...
class RegistersStates : public wxDialog 
{
	...
	public:
		...
		RegistersStates( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "Registers States", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 374,388 ), long style = wxCAPTION|wxCLOSE_BOX|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxRESIZE_BORDER|wxSYSTEM_MENU );
		~RegistersStates();
...
class Memory : public wxDialog 
{
	...
	public:
		...
		Memory( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "Memory", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 612,676 ), long style = wxCAPTION|wxCLOSE_BOX|wxMAXIMIZE_BOX|wxMINIMIZE_BOX|wxRESIZE_BORDER|wxSYSTEM_MENU );
		~Memory();
...
class IDE : public wxFrame 
{
	...
	public:
		...
		IDE( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "Z80 Assembler", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 500,300 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~IDE();
...
class DiscEditor : public wxFrame 
{
	...
	public:
		...
		DiscEditor( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = "DiskSwissKnife", const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 641,743 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~DiscEditor();
